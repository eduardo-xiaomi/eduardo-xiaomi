...
function mudarImagemEFundo(estacao) {
    ...
    switch(estacao) {
        case "Verão":
            imagem.src = "./image/verao.jpg";
            corpo.style.backgroundColor = 'yellow';
            break;
        case "Outono":
            imagem.src = "./image/outono.jpg";
            corpo.style.backgroundColor = 'brown';
            break;
        case "Inverno":
            imagem.src = "./image/inverno.png";
            corpo.style.backgroundColor = 'gray';
            break;
        case "Primavera":
            imagem.src = "./image/primavera.jpg";
...
//dado um numero retorna a estação do ano
